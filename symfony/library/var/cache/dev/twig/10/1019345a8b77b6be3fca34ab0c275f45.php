...
class __TwigTemplate_e293480c59b28802e7d068570fa6969a extends Template
{
...
<table>
    ...
    <tbody>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["book"]) {
            ...
            <td>";
            // line 20
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["book"], "id", [], "any", false, false, false, 20), "html", null, true);
            yield "</td>
            <td>";
            // line 21
            ...
            <td>";
            // line 23
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["book"], "description", [], "any", false, false, false, 23), "html", null, true);
            yield "</td>
            <td>";
            // line 24
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["book"], "imageUrl", [], "any", false, false, false, 24), "html", null, true);
            yield "</td>
        </tr>
        ";
        }
...
";
    ...
    {
        return array (  131 => 27,  122 => 24,  118 => 23,  114 => 22,  110 => 21,  106 => 20,  103 => 19,  99 => 18,  85 => 6,  75 => 5,  58 => 3,  41 => 1,);
    }
