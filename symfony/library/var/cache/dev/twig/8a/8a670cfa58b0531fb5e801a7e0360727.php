...
class __TwigTemplate_df38d403c7ec370234ec93733dbcd8c7 extends Template
{
    ...
    <tbody>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["book"]) {
            ...
            <td>
                <a href=\"";
            // line 22
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("book_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["book"], "id", [], "any", false, false, false, 22)]), "html", null, true);
            yield "\">
                    ";
            // line 23
            ...
            <td>";
            // line 26
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["book"], "author", [], "any", false, false, false, 26), "html", null, true);
            yield "</td>
            <td>";
            // line 27
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["book"], "description", [], "any", false, false, false, 27), "html", null, true);
            yield "</td>
        </tr>
        ";
        }
...
";
    ...
    {
        return array (  149 => 30,  140 => 27,  136 => 26,  130 => 23,  126 => 22,  122 => 20,  118 => 19,  104 => 8,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
<a href=\"{{ path('book_new') }}\">Add new</a>
...
{% endblock %}
", "list/index.html.twig", "D:\\prog\\php\\php-training\\symfony\\library\\templates\\list\\index.html.twig");
    }
}
