...
class Solution
{
    ...
    public function isValidSudoku($board)
    {
        ...
        //validate rows && cols
        for ($k = 0; $k < 9; ++$k) {
            if (!$this->validateRow($board, $k)) {
                return false;
            }
            if (!$this->validateCol($board, $k)) {
                return false;
            }
        }
    ...
    private function validateRow($board, $i_)
    {
        ...
        for ($j = 0; $j < 9; ++$j) {
            ...
            if (isset($collection[$board[$i_][$j]])) {
                return false;
            }
    ...
    private function validateCol($board, $j_)
    {
        ...
        for ($i = 0; $i < 9; ++$i) {
            ...
            if (isset($collection[$board[$i][$j_]])) {
                return false;
            }
